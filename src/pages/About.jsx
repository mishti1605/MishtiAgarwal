    ...
    return (
        <div style={{ background: '#0a0a0a', minHeight: '100vh', color: '#f0f0f0', overflowX: 'hidden' }}>
            ...
            <section className="about-section" style={{
                ...
                {/* Text Content */}
                <div className="about-text-content" style={{ zIndex: 10 }}>
                    <motion.div
                    ...
                    >
                        ...
                        <h1 className="about-title" style={{ fontSize: '4rem', margin: '0 0 2rem 0', lineHeight: '1.1', fontFamily: "'Oswald', sans-serif" }}>
                            FRAMING <br /> THE NARRATIVE
                        </h1>

                        <div className="about-text-lines" style={{
                ...
                <div className="about-canvas-wrapper" style={{ height: '80vh', width: '100%' }}>
